...
public class ArrayPractice {
    ...
    public static void main(String[] args) {
        ...
        int numbers2[] = new int[3];    // creates an array with 3 spots allocated but no real values

        System.out.println(numbers1);
        System.out.println(numbers2);

        int num = numbers1[2];
        System.out.println(num);    // prints value at index 2
         ...
         * 
         * FOR LOOPS
         *      - declare 3 things: iteration variable, condtion, and the step
         */
         ...
         *      -> dont have access to index, just loops through data structures
         */

        System.out.println("FOR EACH LOOP");
        // for integer x within numbers1
        for(int x : numbers1) {
